...
import org.dromara.common.redis.config.CacheConfiguration;
import org.dromara.common.redis.config.IdempotentAutoConfiguration;
...
class RedisConfigurationTest {
    ...
    void shouldCreateIdempotentAndRateLimiterAspects() {
        RepeatSubmitAspect repeatSubmitAspect = new IdempotentAutoConfiguration().repeatSubmitAspect();
